...
{"score": <integer 0-100>, "reason": "<specific explanation>", "matchedEvidence": ["<specific match 1>", "<specific match 2>"], "missingEvidence": ["<specific gap or unknown>"]}

RESPONSE QUALITY RULES:
- Be specific, not generic.
- Mention concrete skills, tools, years, domain experience, and constraints from the job description.
- Include at least 2 matched evidence points and 1 potential gap/unknown when possible.
- Do not say vague phrases like "good match" without details.

EXAMPLE VALID RESPONSE:
{"score": 75, "reason": "Candidate aligns with core frontend stack and product-focused engineering expectations, with one likely seniority gap.", "matchedEvidence": ["Job asks for React + TypeScript and profile shows both in recent projects.", "Role emphasizes API collaboration and profile includes Node/REST delivery experience."], "missingEvidence": ["Job prefers 5+ years in production ownership; profile evidence is closer to mid-level scope."]}
`.trim(),
  },
} as const;
