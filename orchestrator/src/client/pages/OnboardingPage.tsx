...
export const OnboardingPage: React.FC = () => {
  ...
  const isFinishingOnboarding =
    !flow.settingsLoading && flow.complete && onboardingRequirement.checking;
    ...
    <>
      ...
      <PageMain className="space-y-4">
        <div className="grid gap-4 lg:grid-cols-[320px_minmax(0,1fr)]">
          ...
          <Card className="border-border/60 bg-card/40 shadow-none">
            {flow.settingsLoading || !flow.currentStep || isFinishingOnboarding ? (
              ...
              <form
                ...
                onSubmit={async (event) => {
                  ...
                  const result = await flow.handlePrimaryAction();
                  if (result === "ready") {
                    navigate("/jobs/ready");
                  }
                }}
