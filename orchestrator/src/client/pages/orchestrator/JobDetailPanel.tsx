...
export const JobDetailPanel: React.FC<JobDetailPanelProps> = ({
  ...
  if (!selectedJob) {
    return (
      <div className="flex h-full min-h-[200px] flex-col items-center justify-center gap-1 rounded-xl border border-dashed border-border/70 bg-muted/25 text-center">
    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        {canApply && (
          <Button
            size="sm"
            className="h-8 gap-1.5 border border-emerald-400/40 bg-emerald-500/15 text-xs text-emerald-700 hover:bg-emerald-500/25"
            onClick={handleApply}
          >
        ...
        {canMoveToInProgress && (
          <Button
            size="sm"
            className="h-8 gap-1.5 border border-cyan-400/40 bg-cyan-500/15 text-xs text-cyan-700 hover:bg-cyan-500/25"
      ...
      >
        ...
        <TabsContent value="overview" className="space-y-3 pt-2">
          ...
          <div className="space-y-1.5">
            <button
              type="button"
              className="w-full rounded-lg border border-border/50 bg-muted/35 px-2.5 py-2 text-left text-[11px] leading-relaxed text-muted-foreground/85 transition-colors hover:bg-muted/50 line-clamp-4 whitespace-pre-wrap"
