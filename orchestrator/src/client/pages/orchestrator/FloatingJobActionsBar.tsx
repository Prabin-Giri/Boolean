  ...
  return (
    <AnimatePresence initial={false}>
      {selectedCount > 0 ? (
        ...
        >
          <div className="pointer-events-auto flex w-full max-w-md flex-col items-stretch gap-2 rounded-2xl border border-border/70 bg-card/95 px-3 py-2 shadow-xl backdrop-blur supports-[backdrop-filter]:bg-card/90 sm:w-auto sm:max-w-none sm:flex-row sm:flex-wrap sm:items-center">
