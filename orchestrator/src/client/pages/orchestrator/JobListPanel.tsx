    ...
    return (
      <div className="surface-panel min-w-0 overflow-hidden">
        <div className="divide-y divide-border/40">
          <div className="flex items-center justify-between gap-3 bg-muted/45 px-4 py-2.5 opacity-100 transition-opacity sm:opacity-60 sm:hover:opacity-100">
            <label
            ...
            {virtualItems.map((virtualRow) => {
              ...
              return (
                <div
                  ...
                  className={cn(
                    "group absolute left-0 top-0 flex w-full cursor-pointer items-center gap-3 border-b border-l-2 px-4 py-3 transition-colors",
                    isChecked
                      ? "!border-l !border-l-primary !bg-primary/10"
                      : "border-l border-l-border/40",
                    isSelected
                      ? "bg-primary/15"
                      : "border-b-border/40 hover:bg-accent/40",
