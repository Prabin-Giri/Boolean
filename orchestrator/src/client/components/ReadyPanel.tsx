...
export const ReadyPanel: React.FC<ReadyPanelProps> = ({
  ...
  const hasTailoringDraft = useMemo(
    () =>
      Boolean(
        job?.tailoredSummary ||
  ...
  return (
    <div className="flex h-full flex-col">
      <JobHeader job={job} className="border-b border-border/50 pb-4" />
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          ...
          >
            ...
            <span className="truncate">
              {hasTailoringDraft ? "Review Draft" : "Edit Tailoring"}
            </span>
          </Button>
      ...
      {recentlyApplied && (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-2rem)] max-w-xl">
          <div className="flex flex-wrap items-center gap-3 rounded-xl border border-border/70 bg-card/95 px-4 py-2 shadow-lg backdrop-blur-sm">
