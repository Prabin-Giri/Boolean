...
vi.mock("./discovered-panel/TailorMode", () => ({
  TailorMode: ({
    onBack,
  }: {
    onBack: () => void;
  }) => (
    <div data-testid="tailor-mode">
...
describe("ReadyPanel", () => {
  ...
  it("exposes a direct review action for generated drafts", async () => {
    render(
      <MemoryRouter>
        <ReadyPanel
          job={createJob({
    ...
    expect(await screen.findByTestId("tailor-mode")).toBeInTheDocument();
  });
